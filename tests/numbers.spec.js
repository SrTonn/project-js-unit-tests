...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Verifica se a função `numbers` retorna `false` quando o array contém numero como string', () => {
  ...
  it('Verifica se a função `numbers` retorna `false` quando o array contém um espaço vazio', () => {
